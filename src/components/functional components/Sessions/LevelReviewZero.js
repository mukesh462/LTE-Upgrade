  ...
  const updateFeedback = async (
    ...
    axios
      ...
      .then((response) => {
        ...
        fetchLevels(levelId, id, level_name, true);
        if (name == "session21") {
          Toast.show({
            type: "success",
            text1: "Success",
  ...
  const retakeSession = async (
    ...
    axios
      ...
      .then((response) => {
        ...
        fetchLevels(levelId, id, level_name, true,"Retake initiated");
        ...
        >
          ...
          >
            <ProgressBar
              ...
              color={
                data2.progress == data.total ? COLORS.green : COLORS.yellow
              }
              progress={data2.progress / data.total}
              ...
              >
                ...
                >
                  ...
                  (ele.audio_details[0].audio_status === "approved" &&
                    ele.audio_details[1].audio_status === "approved") ||
                  (inter && ele.session_name == "session21") ||
                  (ele.audio_details[0].audio_status === "submitted" &&
                    ele.audio_details[1].audio_status === "submitted") ? (
                    <>
                    ...
                    <>
                      ...
                      >
                        <TouchableOpacity
                          onPress={() =>
                            audioSubmitBtn2(ele.audio_details[1].audio_status)
                          }
                        >
                          <Feather
                            style={Style.uploadIcon}
                          ...
                          <Text style={Style.uploadText}>
                            {(ele.audio_details[1]
                              ? ele.audio_details[1].audio_status == "null"
                              : true) &&
                            fileResponse2.assets[0].name == undefined
                              ? "Drop files here or click to upload"
                              : fileResponse2.assets[0].name == undefined
                              ? ele.audio_details[1].audio_status
                              : ""}
                          </Text>
                        </TouchableOpacity>
                        {fileResponse2.assets[0].name != undefined ? (
                          ...
                          >
                            <Text>{fileResponse2.assets[0].name}</Text>
